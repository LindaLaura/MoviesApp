    ...
    return(
        <MapContainer center={[18.482214, -69.914311]} zoom={14} style={{height:props.height}}>
            ...
            {coordinates.map((coordinate, index) => 
                <Marker key={index} icon={new Icon({iconUrl: markerIconPng, shadowUrl: markerIconShadow, iconSize: [25, 41], iconAnchor: [12, 41]})} position={[coordinate.lat, coordinate.lng]}/>)
            }
        </MapContainer>
    )
}
